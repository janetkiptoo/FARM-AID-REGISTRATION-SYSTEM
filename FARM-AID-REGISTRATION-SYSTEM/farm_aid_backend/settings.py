"""
Django settings for farm_aid_backend project.
...
SECRET_KEY = 'django-insecure-ei!@i1&ta9_a&1kv+%+kytc%nrq8kp13)fo$vtofix+e7eka8-'
...
WSGI_APPLICATION = 'farm_aid_backend.wsgi.application'
